import { createTheme, Footer, FooterBrand, FooterCopyright, FooterDivider, FooterLink, FooterLinkGroup, ThemeProvider } from "flowbite-react"
...
const FootBar = () => {
  return (
    <Footer theme={footerTheme} container>
        ...
        <FooterDivider />
        <FooterCopyright className="text-white" href="#" by="DAC-STUDENTS" year={2025} />
      </div>
    </Footer>
  )
}
