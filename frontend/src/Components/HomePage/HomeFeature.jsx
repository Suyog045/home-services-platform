  ...
  return (
    <div className="mt-20 ml-5 mr-5 md:ml-10 md:mr-20 flex md:flex-row flex-col justify-around items-center md:gap-30 gap-4">
      ...
      <div className="flex flex-col gap-2 md:w-1/3">
        <h3 className="text-primary font-semibold text-center md:text-left">Why We ?</h3>
        <div className="mb-2 flex flex-col md:items-start items-center ">
          ...
          <p className="md:text-wrap mt-3 text-center md:text-left ">Subsidized housing programs, government schemes, and co-operative housing societies often provide more affordable options</p>
        </div>
