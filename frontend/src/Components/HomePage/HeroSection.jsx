  ...
  return (
    <div className="md:h-screen mt-0 bg-primary mb-4 flex md:flex-row flex-col justify-center md:gap-22">
      <div className="flex gap-5 flex-col md:justify-center">
        <h2 className="text-white md:text-left text-center text-4xl md:text-6xl font-bold text-wrap mt-24 md:mt-4">
          Lorem ipsum dolor <br /> sit amet
        </h2>
        <p className="text-white md:text-left text-center text-xl md:text-2xl font-medium text-wrap">
