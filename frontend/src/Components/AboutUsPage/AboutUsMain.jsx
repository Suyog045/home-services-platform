      ...
      <div className="flex flex-col md:flex-row justify-center mt-10 md:mx-30 flex flex-col w-3/4 gap-8">
        <div className="md:mt-4  justify-center  ">
          ...
          <div className="flex text-wrap md:w-3/4 text-center md:text-left md:ml-10 ">
            At [Your Brand Name], we believe your home deserves the best care.
            Whether it's fixing a leaky faucet, deep cleaning your living space,
            or tackling electrical and appliance issues — we bring professional,
            reliable, and affordable solutions right to your doorstep.
          </div>
        </div>
      ...
      <div className="flex flex-col md:flex-row md:justify-between mt-10 md:mx-30 flex flex-col w-3/4 md:gap-8">
        ...
        <div className=" md:mt-4 md:ml-35 ">
          ...
          <div className="flex text-wrap text-center  mb-12 md:mb-0 md:text-left md:ml-10">
            We are a passionate team of skilled professionals, technicians, and
            support staff committed to simplifying your daily life. With a focus
            on quality, safety, and customer satisfaction, we aim to become your
            one-stop destination for all home service needs.
          </div>
        </div>
      </div>
    </div>
